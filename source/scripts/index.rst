...
As for actualy script editing, you can edit them through the admin. However, a much more powerful option is to use an editor like :Pycharm:`https://www.jetbrains.com/pycharm/` which connects to your instances via :sftp:`../misc/sftp`. 
